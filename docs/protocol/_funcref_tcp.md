...
| `0x8385` | S→C | CharList — 209–225B; `[session_byte u16][char_count][struct_size=0x29][char_count× 41B char_struct]`; empty slot = `ff ff ff ff…` CHARDUMMY. char_count = slot-array length, **client HARD-CAPS at 4** (count>4 crashes login, verified 2026-06-06); retail always 4 | reply to `0x8480`/`0x8482` | [`tcp_s2c_8385.md`](packets/tcp_s2c_8385.md) |
