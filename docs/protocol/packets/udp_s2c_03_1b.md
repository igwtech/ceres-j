...
| `[ 3..4] 2B 0x00 0x00 CONSTANT` | padding |  |
| `[ 3..4] 2B 0x00 0x80 CONSTANT (marker B)` | discriminator |  |
| `[ 5] 1B 0x09 CONSTANT (variant marker)` | discriminator |  |
| `[ 5] 1B 0x20 CONSTANT (marker — distinguishes` | discriminator |  |
| `[10] 1B 0xff CONSTANT` | UNVERIFIED |  |
| `[18..27] 10B 0x00 padding CONSTANT` | padding |  |
| `[36..39] 4B 0x00 0x00 0x00 0x00 CONSTANT` | padding |  |
| `[40..46] 7B 0x16 0x03 0x05 0x87 0x03 CONSTANT trailer (5B` | UNVERIFIED |  |
<!-- /constants-audit -->
