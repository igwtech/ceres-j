...
| Field | kind | note |
|---|---|---|
| `[0..2] 2c 01 01 CONSTANT (4/4 retail captures)` | UNVERIFIED | variant discriminator collapse (0x01/0x02) |
| `[0] 0x2c sub-opcode (constant)` | discriminator |  |
| `[19..28] 10 zero bytes CONSTANT padding` | padding |  |
<!-- /constants-audit -->
