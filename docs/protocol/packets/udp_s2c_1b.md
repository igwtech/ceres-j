...
| Field | kind | note |
|---|---|---|
| `[ 0] 1B 0x1b CONSTANT (sub-opcode)` | discriminator |  |
| `[ 3] 1B 0x00 CONSTANT` | padding |  |
| `[ 4] 1B 0x00 CONSTANT` | padding |  |
| `[ 5] 1B 0x1f CONSTANT (inner opcode)` | discriminator |  |
| `[15] 1B 0x00 CONSTANT` | padding |  |
| `[16] 1B 0x00 CONSTANT` | padding |  |
<!-- /constants-audit -->
